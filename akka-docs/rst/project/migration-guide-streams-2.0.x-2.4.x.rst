...
-------------------------------------------------------
To provide a more clear signatures and have a unified API for both
Java and Scala two new types has been introduced:
...
that does not materialize into any value.
...
These changes applies to all the places where streams are used, which means that signatures
